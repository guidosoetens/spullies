...
function broadcastMessage(isKey:boolean, key:string, hue:number, unit:number) {
...
function broadcastKeyMessage(key:string) {
    broadcastMessage(true, key, 0, 0);
}

function broadcastHueMessage(hue:number, unit:number) {
...
function fitApp(app:ActiveHues.GameContainer) {
