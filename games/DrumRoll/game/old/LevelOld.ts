...
module DrumRollGame {
    export const touchRadius: number = 150.0;

    export class LevelOld extends PIXI.Container {
        ...
        update(dt: number) {
            ...
            console.log("speed:", this.rotationSpeed);
            ...
            if (toPt.length() > touchRadius)
                toPt.normalize(touchRadius);
            toPt.multiply(1.0 / touchRadius);
            if (closestPoint)
            ...
            */
            ...
            if (this.hasInput && DEBUG_MODE) {
                ...
                this.graphics.drawCircle(this.width / 2, 100, touchRadius);
