...
module DrumRollGame {
    ...
    export class GameContainer extends PIXI.Application {
        ...
        loadGame() {
            ...
            var thickness: number[] = [2, 1];
            var offset: number[] = [0, 0];
            var colors: number[] = [0x777777, 0xaaaaaa];
        ...
        pointerDown(event: PIXI.interaction.InteractionEvent) {
            ...
            var touch: touchElementOLD = new touchElementOLD();
